...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Loomly — Instagram accounts for founders" },
      { property: "og:description", content: "We create warmed-up Instagram accounts and let you schedule posts. $49/account/month." },
